...
name: rca-analyzer
description: >-
  Run a 5-Whys and fishbone root-cause analysis on a defect and propose
  CAPA (corrective/preventive actions). Use when a tester or lead asks for
  a root-cause analysis, or after a Critical/High bug is fixed and needs a
