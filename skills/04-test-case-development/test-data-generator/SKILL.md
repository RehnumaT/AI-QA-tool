...
description: >-
  Produce valid, invalid, boundary, and synthetic data sets per field for a
  test case or scenario, backed by a real generator script rather than
  inline invented values. Use when a test case needs concrete data or a
  tester asks "generate test data for <field/form>".
license: MIT
metadata:
