...
description: >-
  Turn approved test scenarios into step-by-step executable test cases with
  numbered steps, expected results per step, and traceability back to the
  source AC/scenario. Use when a tester says "write test cases for these
  scenarios" or "make this scenario executable".
license: MIT
metadata:
  author: Rehnuma Tarannum
  pack: stlc-skill-pack
  phase: "04-test-case-development"
---
