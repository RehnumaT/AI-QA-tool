---
mode: agent
description: "Given a change description (diff summary, PR description, or affected files), select a risk-ranked subset of the regression suite instead of re-running everything. Use when a tester asks \"what regression tests do I need for this PR\" or \"can I skip the full suite for this change\"."
---
