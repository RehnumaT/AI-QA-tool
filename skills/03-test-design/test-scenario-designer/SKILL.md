...
description: >-
  Expand approved acceptance criteria into positive, negative, boundary, and
  cross-role test scenarios, each risk-tagged. Use after a test plan is
  approved and before test cases are written, or whenever a tester asks
  "what scenarios am I missing for this feature".
license: MIT
metadata:
