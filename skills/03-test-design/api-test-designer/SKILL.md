...
description: >-
  Turn an API endpoint or contract (OpenAPI spec, curl example, or plain
  description) into a coverage matrix spanning happy path, schema
  validation, auth, negative, and boundary cases. Use when a tester says
  "design API tests for this endpoint" or hands over a spec/contract.
license: MIT
metadata:
