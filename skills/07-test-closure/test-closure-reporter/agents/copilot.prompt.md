---
mode: agent
description: "Roll up a test cycle's metrics (coverage, pass rate, open defects, regression selection) into a closure report with an advisory go/no-go. Use when a tester or lead asks \"are we ready to ship\" or \"write the test closure report for this release\"."
---
