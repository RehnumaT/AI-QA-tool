...
description: >-
  Build a requirements-to-tests traceability matrix and surface untested
  areas. Use when a tester or lead asks "what's our coverage on this
  feature/release" or "are we missing tests for any AC".
license: MIT
metadata:
